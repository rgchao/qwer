...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/teacher/statistics.css">
</head>
<body>
	<!--头部-->
	...
	<div id="wait">
		...
		<img src="/static/images/wait.gif">&nbsp;&nbsp;正在统计，请稍候...
	</div>
	<!-- 图示 -->
...
<script src="${pageContext.request.contextPath}/static/script/teacher/statistics.js"></script>
</html>