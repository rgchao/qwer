                ...
                <table class="table table-hover table-bordered">
                    ...
                    <c:forEach items="${pageBean.list}" var="student">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-default btn-xs" onclick="toggleStudentEdit(true,this, '${student.id}')">编辑
                                </button>
                                <button class="btn btn-danger btn-xs" onclick="deleteStudent('${student.id}')">删除</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
