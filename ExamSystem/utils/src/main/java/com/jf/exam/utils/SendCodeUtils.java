...
public class SendCodeUtils {
    public static void main(String[] args) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAIp3txqPYOT8qs";
        final String accessKeySecret = "vphLX4J74uIcfa6chfFdSrUz3vThIb";//你的accessKeySecret，
        ...
        request.setPhoneNumbers("17772266331");
     ...
     /*模版内容:
          尊敬的用户，您的验证密码为：${code}，请勿泄漏于他人！ 发送人：java开发工程师*/
